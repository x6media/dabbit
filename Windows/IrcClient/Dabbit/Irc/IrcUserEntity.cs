...
{
    class IrcUserEntity : IrcFromEntity
    {
        /// <summary>
        ...
        public IrcUserEntity(string nickname, string ident, string real)
            : base(typeof(IrcUserEntity), nickname)
        {
        ...
        public string DisplayFull
        {
            get
            {
                ...
                {
                    throw new UserEntityNoHostException(this.Nickname + "!" + this.Ident);
                }
