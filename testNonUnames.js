...
function StringTestSocket(read, write) {
    ...
    var input = ":hyperion.gamergalaxy.net 001 lkjfsdlkf :Welcome to the Gamer Galaxy IRC IRC Network lkjfsdlkf!dabitp@76.178.154.95" + "\r\n" +
        ...
        ":hyperion.gamergalaxy.net 005 lkjfsdlkf CMDS=KNOCK,MAP,DCCALLOW,USERIP SAFELIST HCN MAXCHANNELS=60 CHANLIMIT=#:60 MAXLIST=b:60,e:60,I:60 NICKLEN=30 CHANNELLEN=32 TOPICLEN=307 KICKLEN=307 AWAYLEN=307 :are supported by this server" + "\r\n" +
        ...
        ":hyperion.gamergalaxy.net 353 lkjfsdlkf = #DAB :lkjfsdlkf Jiggler %DeBot Guest41609 @synapse &DoBot josh &FoxTrot ~dab %dab- Redirect_Left" + "\r\n" +
        ...
        ":hyperion.gamergalaxy.net MODE #DAB -hq DeBot dab" + "\r\n" +
        ":hyperion.gamergalaxy.net 353 lkjfsdlkf = #DAB :lkjfsdlkf Jiggler +DeBot Guest41609 @synapse &DoBot josh &FoxTrot @dab %dab- Redirect_Left" + "\r\n" +
        ":hyperion.gamergalaxy.net 366 lkjfsdlkf #DAB :End of /NAMES list." + "\r\n" +
...
ctx.Server.Events.on('OnRawMessage', function(svr, e) {
    ...
    if ("999" == e.Command) {
        ...
        Assert.equal(false, ctx.Server.MultiModes, "Namesx detected");
        ...
        Assert.equal("NAMES #dab", writtenLines[++readI].trim(), "Unexpected NAMES");
        readI++;
